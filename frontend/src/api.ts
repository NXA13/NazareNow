...
export interface DayCall {
   ...
   * largest overclaim in the interface, which is why `PlausibleRange` names the condition this
   * figure prices in the same sentence as the figure, and then lists what is missing.
   *
